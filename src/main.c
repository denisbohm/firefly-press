...
static const firmware_information_t firmware_information = {
    .magic = 0xfeedcafe,
    .version = {
        .major = 1,
        .minor = 0,
        .revision = 1,
        .commit = {
            .data = {0x8d, 0x62, 0xe5, 0xb7, 0x61, 0xd2, 0x59, 0x09, 0x3e, 0x4b, 0xb4, 0x3b, 0xc1, 0x9a, 0xa2, 0x96, 0xf9, 0xc2, 0x92, 0x66}
        }
    }
};
